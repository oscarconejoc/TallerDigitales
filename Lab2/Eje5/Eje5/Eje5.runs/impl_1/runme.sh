...
HD_PWD='C:/Users/oscar/OneDrive/Escritorio/TallerDigitales/Lab2/Eje5/Eje5/Eje5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopFSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopFSM.tcl -notrace
