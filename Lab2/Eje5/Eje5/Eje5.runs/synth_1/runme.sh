...
HD_PWD='C:/Users/oscar/OneDrive/Escritorio/TallerDigitales/Lab2/Eje5/Eje5/Eje5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopFSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopFSM.tcl
