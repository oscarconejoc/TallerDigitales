...
#
# Script generated by Vivado on Mon Jun 09 11:57:10 -0600 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clock_16MHz.sh
...
#
# Usage        : clock_16MHz.sh
#                clock_16MHz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_16MHz.sh [-reset_run]
#                clock_16MHz.sh [-reset_log]
#                clock_16MHz.sh [-help]
#
...
# script info
echo -e "clock_16MHz.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_16MHz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock_16MHz xil_defaultlib.clock_16MHz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock_16MHz -key {Behavioral:sim_1:Functional:clock_16MHz} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clock_16MHz.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clock_16MHz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clock_16MHz.sh [-help]\n\
Usage: clock_16MHz.sh [-step]\n\
Usage: clock_16MHz.sh [-lib_map_path]\n\
Usage: clock_16MHz.sh [-reset_run]\n\
Usage: clock_16MHz.sh [-reset_log]\n\
Usage: clock_16MHz.sh [-keep_index]\n\
Usage: clock_16MHz.sh [-noclean_files]\n\n\
