...
#
# Script generated by Vivado on Sun Jun 08 00:58:02 -0600 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FIFO_Prueba.sh
...
#
# Usage        : FIFO_Prueba.sh
#                FIFO_Prueba.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIFO_Prueba.sh [-reset_run]
#                FIFO_Prueba.sh [-reset_log]
#                FIFO_Prueba.sh [-help]
#
...
# script info
echo -e "FIFO_Prueba.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIFO_Prueba.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIFO_Prueba xil_defaultlib.FIFO_Prueba xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FIFO_Prueba -key {Behavioral:sim_1:Functional:FIFO_Prueba} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FIFO_Prueba.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FIFO_Prueba.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FIFO_Prueba.sh [-help]\n\
Usage: FIFO_Prueba.sh [-step]\n\
Usage: FIFO_Prueba.sh [-lib_map_path]\n\
Usage: FIFO_Prueba.sh [-reset_run]\n\
Usage: FIFO_Prueba.sh [-reset_log]\n\
Usage: FIFO_Prueba.sh [-keep_index]\n\
Usage: FIFO_Prueba.sh [-noclean_files]\n\n\
