...
HD_PWD='C:/VivadoProjects/Eje_4_Ahora_Si/Eje_4_Ahora_Si.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_tbb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_tbb.tcl
