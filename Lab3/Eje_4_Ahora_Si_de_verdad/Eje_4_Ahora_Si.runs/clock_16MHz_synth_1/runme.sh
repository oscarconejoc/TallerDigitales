...
HD_PWD='C:/VivadoProjects/Eje_4_Ahora_Si/Eje_4_Ahora_Si.runs/clock_16MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_16MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_16MHz.tcl
